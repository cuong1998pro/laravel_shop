                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="/whistlist"><i class="fa fa-star"></i> Sản phẩm yêu thích</a></li>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            ...
                            <li><a href="<?php echo e(URL::to('home')); ?>" class="active">Trang chủ</a></li>
                                ...
                                <li class="dropdown"><a href="#">Tin tức<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="blog-single.html">Tin vắn</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian">
                            ...
                            <div class="panel panel-default">
                                ...
                                <h4 class="panel-title"><a href="<?php echo e(URL::to("/danh-muc-san-pham/$value->category_id")); ?>"><?php echo e($value->category_name); ?></a></h4>
                                </div>
                            </div>
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                ...
                                <li><a href="<?php echo e(URL::to("/thuong-hieu-san-pham/$value->brand_id")); ?>"> <span class="pull-right">(50)</span><?php echo e($value->brand_name); ?></a></li>
                                </ul>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php /**PATH /var/www/html/store/resources/views/layout.blade.php ENDPATH**/ ?>