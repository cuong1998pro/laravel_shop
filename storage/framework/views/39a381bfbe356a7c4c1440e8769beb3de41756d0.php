    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"><?php echo e(Session::get('admin_name')); ?></span>
                <b class="caret"></b>
            </a>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
					...
					<li><a href="<?php echo e(URL::to('/all-category-product')); ?>">Danh sách danh mục sản phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
					...
					<li><a href="<?php echo e(URL::to('/all-brand-product')); ?>">Danh sách thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
					...
					<li><a href="<?php echo e(URL::to('/all-product')); ?>">Danh sách sản phẩm</a></li>
                    </ul>
                </li>
            </ul>
			</div>
...
<!--[if lte IE 8]><script language=<?php echo e(asset('backend/javascript" type="text/javascript" src="js/flot-chart/excanvas.min.js')); ?>"></script><![endif]-->
...
<?php /**PATH /var/www/html/store/resources/views/admin_layout.blade.php ENDPATH**/ ?>