...
<div class="product-details">
    ...
    <div class="col-sm-5">
        <div class="view-product">
            <img src="{{URL::to('uploads/product/'.$details->product_image)}}" alt="" />
            <h3>ZOOM</h3>
        </div>
    ...
    <div class="col-sm-7">
        <div class="product-information">
            ...
            <p>Mã số: {{$details->product_id}}</p>
            <img src="{{asset('frontend/images/product-details/rating.png')}}" alt="" />
            <span>
                <form action="{{URL::to('/save-cart')}}" method="post">
                    {{ csrf_field() }}
                    <span>{{number_format($details->product_price).' '.'đ'}}</span>
                    <label>Số lượng:</label>
                    <input type="text" value="1" min="1" name="quantity" />
                    <input type="hidden" value="{{$details->product_id}}" min="1" name="product_id_hidden" />
...
<div class="recommended_items">
    ...
    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="item active">
                @for($i=0;$i<sizeof($related_products);$i++) <div class="col-sm-4">
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{URL::to('uploads/product/'.$related_products[$i]->product_image)}}"
                                    alt="" />
                                <h2>$56</h2>
