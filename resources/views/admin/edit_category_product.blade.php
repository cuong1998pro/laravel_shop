            ...
            <div class="panel-body">
                <div class="position-center">
                    ...
                    <form role="form" action="{{URL::to("/update-category-product/$category->category_id")}}" method="post">
                        ...
                        placeholder="Nhập tên danh mục" value="{{$category->category_name}}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mô tả danh mục:</label>
                            <textarea class="form-control" id="exampleInputPassword1"
                                name="category_product_description" placeholder="Mô tả danh mục">{{$category->category_desc}}</textarea>
                        </div>
                        <div class="form-group">
